    ...
    <div className="global-wrapper">
      ...
      <header className="global-header">
        <nav className="main-nav">
          ...
          <button className={`toggle-search-btn ${animation} ${(searchIsOpen) ? "opened" : ""}`} onClick={toggleSearch}>
          ...
          <div className={`search-form-wrapper ${(searchIsOpen) ? "opened" : ""}`}>
            <form className="search-form">
              <button className={`search-btn ${animation}`} type="submit" disabled={!searchIsOpen}>
